...
# Output file
# file = "2024_07_03_CW_100hzTTLModulation_256ns_si"
# file = "2024_07_03_PD_Response_10HzTTL"
# file = "2024_07_03_CW_noTTLModulation3"
file = "2024_07_03_ResonanceDrift_Data_noSweep"
...
# Set up channel B
channel_rangeB = ps.PS5000A_RANGE['PS5000A_5V']
...
print(f"Capture Time = {np.round(actualSampleInterval*numBuffersToCapture*sizeOfOneBuffer,2)} s")
...
file = f"{file}_piezo_{freq}.csv"

df = pd.DataFrame({"time (s)" : time, 
                   "LD TTL (mV)" : adc2mVChBMax,
